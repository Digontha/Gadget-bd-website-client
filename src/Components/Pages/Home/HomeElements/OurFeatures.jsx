    ...
    return (
        <div className='py-10 w-[90%] mx-auto'>
                ...
                <div className='m-5  bg-red-500 w-[500px] p-10 rounded-xl'>
                 ...
                 <div className='m-5  bg-gray-300 w-[500px] p-10  rounded-xl'>
                 ...
                 <div className='m-5  bg-blue-300 w-[500px] p-10  rounded-xl'>
                 ...
                 <div className='m-5  bg-purple-300 w-[500px] p-10  rounded-xl'>
